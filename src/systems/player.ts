  ...
  GetPlayerLoginData: async (username: string) => {
    ...
    const mainQuery = `
      SELECT
        ...
        eq.shoulder AS eq_shoulder,
        eq.chest AS eq_chest,
        eq.wrists AS eq_wrists,
        eq.hands AS eq_hands,
        eq.waist AS eq_waist,
        eq.legs AS eq_legs,
        eq.feet AS eq_feet,
    ...
    return {
      ...
      equipment: {
        ...
        shoulder: data.eq_shoulder,
        chest: data.eq_chest,
        wrists: data.eq_wrists,
        hands: data.eq_hands,
        waist: data.eq_waist,
        legs: data.eq_legs,
        feet: data.eq_feet,
