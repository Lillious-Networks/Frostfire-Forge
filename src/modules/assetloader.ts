...
const creatureNow = performance.now();
await creatureRepository.loadIntoCache();
log.success(`Loaded creature data from the database in ${(performance.now() - creatureNow).toFixed(2)}ms`);
