    ...
    <div className="env-container">
      <header className="env-header">
        ...
        <div className="env-badges">
          <span className="env-badge env-badge-important">⚠️ Required for Production</span>
          <span className="env-badge env-badge-success">✓ Development Ready</span>
          <span className="env-badge env-badge-info">Multiple Environments</span>
        </div>
      </header>

      <div className="env-content">
        {/* Quick Navigation */}
        <div className="env-quick-nav">
          <a href="#overview" className="env-quick-link">📋 Overview</a>
          <a href="#database" className="env-quick-link">🗄️ Database</a>
          <a href="#server" className="env-quick-link">🌐 Server</a>
          <a href="#email" className="env-quick-link">📧 Email</a>
          <a href="#cache" className="env-quick-link">⚡ Cache</a>
          <a href="#api" className="env-quick-link">🔑 API Keys</a>
          <a href="#quick-reference" className="env-quick-link">🚀 Quick Ref</a>
        </div>

        {/* Overview */}
        <section id="overview" className="env-section">
          <h2>
            <span className="section-icon">📋</span>
            Overview
          </h2>
          
          <div className="env-note env-note-important">
            <p>
          ...
          <div className="env-note env-note-info">
...
nano .env.production`}</code></pre>
        ...
        <section id="database" className="env-section">
          <h2>
            <span className="section-icon">🗄️</span>
            Database Configuration
          </h2>
          
          <p>Configure your database connection settings for MySQL or SQLite.</p>

          <div className="env-variable-list">
            <div className="env-variable-card env-variable-required">
              <div className="env-variable-header">
                <h3>DATABASE_ENGINE</h3>
                <span className="env-required">Required</span>
              </div>
            ...
            <div className="env-variable-card env-variable-required">
              <div className="env-variable-header">
                <h3>DATABASE_HOST</h3>
                <span className="env-required">Required for MySQL</span>
              </div>
          ...
          <h3>Example Database Configuration</h3>
          <div className="env-code-block">
            <div className="env-code-header">
              <span>For MySQL</span>
            </div>
...
# Other database variables can be omitted for SQLite`}</code></pre>
        ...
        <section id="server" className="env-section">
          <h2>
            <span className="section-icon">🌐</span>
            Server Configuration
          </h2>
          
          <p>Configure your web server and application settings.</p>
        ...
        {/* Email Configuration */}
        <section id="email" className="env-section">
          <h2>
            <span className="section-icon">📧</span>
            Email Configuration
          </h2>
          
          <p>Configure email settings for notifications and user verification.</p>
        ...
        {/* Cache Configuration */}
        <section id="cache" className="env-section">
          <h2>
            <span className="section-icon">⚡</span>
            Cache Configuration
          </h2>
          ...
          <div className="env-note env-note-info">
            <p>
              Configure caching system for optimal performance. Redis is recommended for production.
            </p>
          </div>
          ...
          <h3>Cache Configuration Examples</h3>
          <div className="env-code-block">
            <div className="env-code-header">
...
# Redis variables can be omitted`}</code></pre>
        ...
        <section id="api" className="env-section">
          <h2>
            <span className="section-icon">🔑</span>
            API Keys and Services
          </h2>
          
          <p>Configure third-party services and API keys for enhanced features.</p>
        ...
        {/* Quick Reference */}
        <section id="quick-reference" className="env-section">
          <h2>
            <span className="section-icon">🚀</span>
            Quick Reference
          </h2>
          
          <div className="env-note env-note-success">
            <p>
              Here's a complete example configuration file with all recommended settings for production.
            </p>
          </div>

          <div className="env-code-block env-code-block-large">
            <div className="env-code-header">
              <span>Complete .env.production Example</span>
              <button className="env-copy-btn" onClick={() => navigator.clipboard.writeText(`DATABASE_ENGINE="mysql"
DATABASE_HOST="localhost"
DATABASE_NAME="frostfire"
...
VERSION="1.0.0-dev"`}</code></pre>
        ...
        <section className="env-section">
          ...
          <div className="env-next-steps">
            ...
            <div className="env-next-step">
              ...
              <Link to="/docker" className="env-next-link">
                Docker Guide →
              </Link>
            </div>
            ...
            <div className="env-next-step">
              ...
              <Link to="/commands" className="env-next-link">
                Commands Reference →
              </Link>
            </div>
          </div>
      ...
      <div className="env-navigation">
        <Link to="/docker" className="env-nav-link env-nav-prev">
          ← Docker Setup
        </Link>
        <Link to="/commands" className="env-nav-link env-nav-next">
          Commands Reference →
        </Link>
      </div>
    </div>
